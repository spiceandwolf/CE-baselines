...
def get_test_set_e2e_time(test_set_filename, test_set_db, optimal_pg_or_model, db_host="localhost", db_user="postgres", db_user_pwd="postgres", db_port=5433):
    """
...
if __name__ == '__main__':
    ...
    test_set_filename = args.query_file
    test_set_db = args.db
    ...
    all_e2e_times = get_test_set_e2e_time(test_set_filename, test_set_db, optimal_pg_or_model=test_method)
    print(f"total: {sum(all_e2e_times)}, model's e2e time: {all_e2e_times}")
